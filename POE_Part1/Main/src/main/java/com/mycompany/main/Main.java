...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!isValidPassword) {
            System.out.print("Enter password (must contain a capital letter, a special character, a number, and be no more than 8 characters): ");
        ...
        while (!isValidCellphoneNumber) {
            System.out.print("Enter cellphone number (must start with +27 and be 12 digits): ");
